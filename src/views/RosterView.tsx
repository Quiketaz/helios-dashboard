          ...
          <tbody className="divide-y divide-zinc-900">
            {paginatedPax.map((p) => (
              <tr
                ...
                role="button"
                tabIndex={0}
                className="hover:bg-zinc-900/20 transition-colors group cursor-pointer outline-none focus:bg-zinc-900/40"
              >
                <td className="p-5">
        ...
        <div className="md:hidden divide-y divide-zinc-900/50">
          {paginatedPax.map((p) => (
            <div
              ...
              role="button"
              tabIndex={0}
              className="p-4 hover:bg-zinc-900/20 active:bg-zinc-900/40 transition-colors flex items-center justify-between group cursor-pointer outline-none focus:bg-zinc-900/40"
            >
              <div className="flex items-center gap-3">
